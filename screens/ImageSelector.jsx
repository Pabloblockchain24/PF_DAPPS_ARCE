...
import { setCameraImage, setUserPhoto } from '../features/authSlice'
      ...
      {image ? (
        <>
          ...
          <View style={styles.actions}>
            <Pressable style={styles.buttonOtra} onPress={pickImage}>
              <Text>
               TOMAR OTRA
              </Text>
            </Pressable>
            <Pressable style={styles.button} onPress={confirmImage}>
              ...
              <Text> CONFIRMANDO... </Text> : <Text> CONFIRMAR </Text>}
            </Pressable>
          </View>
        </>
      ) : (
